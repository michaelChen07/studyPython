...
try:
    ...
    with open(r"C:\ProgramData\MySQL\MySQL Server 5.6\Uploads\insertUserInfo.txt","wb") as f:
...
#在mysql中执行下列sql
"""LOAD DATA INFILE 'C:\\ProgramData\\MySQL\\MySQL Server 5.6\\Uploads\\insertUserInfo.txt' INTO TABLE t_user
