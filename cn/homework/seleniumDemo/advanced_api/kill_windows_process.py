...
class VisitSogouByIE(unittest.TestCase):
    ...
    def test_killWindowsProcess(self):
        # 启动火狐浏览器
        firefoxDriver = webdriver.Firefox(executable_path = "c:\\geckodriver")
        # 启动IE浏览器
        ieDriver = webdriver.Ie(executable_path = "c:\\IEDriverServer")
        # 启动Chrome浏览器
        #chromeDriver = webdriver.Chrome(executable_path="c:\\chromedriver")
        # 导入Python的os包
        import os
        # 结束Firefox浏览器进程
